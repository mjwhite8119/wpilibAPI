...
left_auto_value = sb.getAutoUpdateValue("Wheel Speed Left", 0)
right_auto_value = sb.getAutoUpdateValue("Wheel Speed Right", 0)

# sd = NetworkTables.getTable("/SmartDashboard")
# left_auto_value = sd.getAutoUpdateValue("leftWheelSpeed", 0)
# right_auto_value = sd.getAutoUpdateValue("rightWheelSpeed", 0)
